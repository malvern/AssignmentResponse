 ...
 */
@Entity(name = "request")
@NamedQueries({@NamedQuery(name = "SubscriberRequest.findByPartnerCode", query = "select r from e_req_partner r where r.partnerCode = :partnerCode order by r.dateCreated desc ")})
